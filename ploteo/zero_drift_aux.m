% Original name: zero_drift_grid_fast_v10_debtprem.m
function [dV0, cF0, cI0, c0, stats] = zero_drift_grid_fast_v10_debtprem( ...
...
if nargin < 18 || isempty(slow_solver)
    error('zero_drift_grid_fast_v10_debtprem requires a slow_solver function handle.');
end
